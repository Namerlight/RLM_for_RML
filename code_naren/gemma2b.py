...
opfile_path = "collected_data.csv"

def random_sample():

    file_path = os.path.join("..", "data", "TruthfulQA", "TruthfulQA.csv")
    data = pd.read_csv(file_path)
    sentences = data['Question']
    sampled_sentences = sentences.sample(n=5, random_state=32)  # random_state for reproducibility
